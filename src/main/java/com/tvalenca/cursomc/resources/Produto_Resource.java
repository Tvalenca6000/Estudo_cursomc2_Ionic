...
import com.tvalenca.cursomc.dto.Produto_DTO;
import com.tvalenca.cursomc.resources.utils.URL;
import com.tvalenca.cursomc.services.Produto_Service;


@RestController
@RequestMapping(value="/produtos")
public class Produto_Resource {
    ...
    public ResponseEntity<Page<Produto_DTO>> findPage(
        ...
        Page<Produto_DTO> listDto = list.map(obj -> new Produto_DTO(obj));
